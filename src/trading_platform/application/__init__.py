...
if TYPE_CHECKING:
    ...
    from .read_model_codecs import encode_read_model
...
_EXPORT_MODULES = {
    ...
    "ConfirmPortfolioRiskPolicy": ".risk_policies",
    "GetPortfolioRiskPolicy": ".risk_policies",
    "PortfolioRiskPolicies": ".risk_policies",
    ...
    "AccountSnapshotEditorViewV1": ".read_models",
    "ChartWorkspaceViewV1": ".read_models",
    "HoldingWorkspaceViewV1": ".read_models",
    "PortfolioWorkspaceViewV1": ".read_models",
    "ReadModelService": ".read_models",
    "ResearchIndexViewV1": ".read_models",
    "PublishLatestResearch": ".research_publication",
    "ResearchPublication": ".research_publication",
    "ResearchPublicationError": ".research_publication",
    "ResearchPublicationResult": ".research_publication",
    "ReviewWorkspaceViewV1": ".read_models",
    "TradePlanDetailViewV1": ".read_models",
    "encode_read_model": ".read_model_codecs",
    ...
    "open_research_publication": ".bootstrap",
