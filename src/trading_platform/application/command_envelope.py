...
_PAYLOAD_SCHEMAS = {
    ...
    "portfolio_risk_policy.confirm@1": "ConfirmPortfolioRiskPolicy@1",
    "trade_plan.prepare_draft@1": "PrepareTradePlanDraft@1",
    ...
    "chart_annotation.apply@1": "ApplyChartAnnotation@1",
    "manual_portfolio_review.run@2": "RunManualPortfolioReview@2",
    ...
    "discipline_review.create_draft@2": "CreateDisciplineReviewDraft@2",
