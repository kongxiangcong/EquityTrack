...
| 4   | Valuation + Catalyst Calendar      | First Half  | Dual-Box                  | `valuation/valuation-method-router.md` | Method states, stress/base/improvement scenarios, bounded estimates, and catalyst evidence                                                                                     |
...
| 10  | Scenario + Risk                    | Second Half | Dual-Box **60%/40%**      | `modules/tables.md`            | Left stress/base/improvement (`.scenario-box`), right risk list (`.risk-box`)                                                                                                          |
